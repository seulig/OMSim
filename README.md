...
- [WavePID](https://icecube.github.io/OMSim/md_extra__doc_233__wavepid.html): injects a primary particle (muon or other) via GPS at a configurable impact parameter and energy, then tracks photon origins (Cherenkov, Scintillation, Bremsstrahlung, etc.) for studying photon arrival time distributions used in the WavePID particle identification method.
